...
(function() {
  var Q, Server, TODO_COUCH_LOCAL, TODO_COUCH_SERVICE, TODO_MONGO_LOCAL, TODO_MONGO_SERVICE, URL, cfCore, cfEnv, couchDB, express, getCouchURL, getMongoURL, http, mongoDB, ports, todoDB, tx, utils, _;
  ...
  Server = (function() {
    ...
    Server.prototype.start = function() {
      ...
      app.listen(this.port, cfCore.bind, (function(_this) {
        return function() {
