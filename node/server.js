...
// } else if (appEnv.getServiceCreds('todo-compose-mongo-db')) {
//   db = require('./lib/compose-db')(appEnv.getServiceCreds('todo-compose-mongo-db'));
// } else if (appEnv.getServiceCreds('todo-cloudant-db')) {
//   db = require('./lib/cloudant-db')(appEnv.getServiceCreds('todo-cloudant-db'));
} else {
